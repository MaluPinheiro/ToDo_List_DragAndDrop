...
function App() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center px-4 pt-20 bg-zinc-900">
      <h1 className="font-bold text-4xl text-white mb-6">Tarefas</h1>
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex flex-row gap-6 w-full max-w-6xl justify-center">
          {Object.entries(columns).map(([columnId, column]) => (
            <section
              key={columnId}
              className="bg-zinc-800 p-4 rounded-md w-full max-w-sm flex flex-col"
            >
